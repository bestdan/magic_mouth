...
## Magic Mouth
An [AI Support for GMs ](ai_support_for_gm.md) running D&D campaigns. 

There is generally an `AGENTS.md` in each sub-directory to explicitly describe how to support the GM. 
...
Helps you set up and run a given session. Fairly structured with templates for: 
 ...
 - setup_players: what you might tell the players ahead of the game
 - encounter: details for the actual encounter, enemies, triggers, running the game
 - notes: where to take notes during the session
 - snak_shop: an optional example of a shop inventory for each session


> Help me set up session 7: I want to use the idea/xyz.md idea for it. There will be 4 level 6 players. 